    ...
    <head>
        ...
        <script language="javascript" type="text/javascript">
            ...
            function showResult() {
            	...
            	//提示信息，由于提交表单后，页面被刷新，导致下面的代码无法执行，以后用ajax解决
                //showResultDiv(true);
        ...
        <div id="main">            
            ...
            <form action="add.do" method="post" class="main_form">
                ...
                <div class="input_info fee_type">
                    ...
                    <input type="radio" name="costType" checked="checked" id="package" value="2" onclick="feeTypeChange(2);" />
